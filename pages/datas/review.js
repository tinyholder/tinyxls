...
Page({
  ...
  detail: function (e) {
    ...
    wx.navigateTo({
      url: `/pages/datas/detail/detail?id=${e.target.dataset.id}&catid=${catid}`,
    });
  },
  ...
  menuItemClick: function (res) {
    ...
    if (parseInt(clickInfo.id) == 1) {
      ...
      wx.navigateTo({
        url: `/pages/datas/detail/detail?id=0&catid=${catid}`,
      });
    }
  },
  onVisibleChange({
